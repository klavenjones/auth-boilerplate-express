...
const PassportLinkedInToken = passport.authenticate("linkedin-token-signin", {
  session: false
});

const PassportLinkedInTokenSignUp = passport.authenticate(
