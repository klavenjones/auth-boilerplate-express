...
const LinkedInTokenStrategySignUp = require("passport-linkedin-token-v2");
...
passport.use(
  "linkedin-token-signin",
  new LinkedInTokenStrategy(
    {
      clientID: config.linkedin.clientID,
      clientSecret: config.linkedin.clientSecret,
      redirectURL: config.linkedin.SignInRedirectURL,
...
//Linkedin OAUTH SIGN UP STRATEGY
passport.use(
  "linkedin-token-signup",
  new LinkedInTokenStrategySignUp(
    {
      clientID: config.linkedin.clientID,
      clientSecret: config.linkedin.clientSecret,
      redirectURL: config.linkedin.SignUpRedirectURL,
      scope: ["r_emailaddress", "r_liteprofile"]
    },
    async (req, accessToken, refreshToken, profile, done) => {
      console.log("Access Token", accessToken);
